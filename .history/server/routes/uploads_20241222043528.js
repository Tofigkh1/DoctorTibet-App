...
export async function handlerUploadPOST(req, res, folder) {
  try {
    ...
    const { video, coverImage, id: formId } = form.files;
    ...
    // Gelen `id`yi kullan ya da yeni bir `id` oluştur
    ...
    // Firestore'da categoryVideoID oluştur ya da güncelle
    ...
    await setDoc(categoryVideoRef, categoryVideoData, { merge: true }); // Mevcut belgeyi güncelle ya da oluştur
