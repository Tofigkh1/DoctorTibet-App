...
import { storage, firestore } from "../configs/firebase"; // Firestore yapılandırmanızın yolu
...
export async function handlerUploadPOST(req, res, folder) {
  try {
    ...
    // Firestore'dan categoryVideo koleksiyonundan id'ye ait adı al
    ...
    // Yeni bir koleksiyon oluştur ve bilgileri yaz
