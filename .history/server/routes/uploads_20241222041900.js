...
import { storage } from "../configs/firebase"; // Firebase yapılandırmanız
...
export async function handlerUploadPOST(req, res, folder) {
  try {
    ...
    // Firestore'da categoryVideo koleksiyonuna belge ekleme
    ...
    await firestore.collection("categoryVideo").doc(id).set(categoryVideoDoc);
