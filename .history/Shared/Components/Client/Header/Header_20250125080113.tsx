...
import { Chatbot } from "../../../Components/Client/AiChatBot/Chatbot";
...
<div>
  ...
  <div className={styles.bgimage}>
   ...
   <div>
   <Chatbot isVisible={isVisible} toggleChat={toggleChat} />
   </div>
        ...
        <div className={styles.bgimage}>
            <section className={`${styles.header_box}  ${isOpen ? styles.shadow : ''}`}>
                <div className={`${styles.logo_box} flex gap-3 items-center`}>
                    <button className={styles.button}></button>
                    <div className={styles.cursor}>
                        <img onClick={() => push('/')} style={{width: '90px', height: '90px'}} className={styles.logo}
