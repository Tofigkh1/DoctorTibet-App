  ...
  {chatHistory.map((msg, index) => (
    ...
    >
      ...
      >
        {msg.role === "assistant" && (
    <div
    className=" flex justify-center items-center w-16 h-16 bg-blue-500 hover:bg-blue-600 text-white rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:scale-110 z-[99999] cursor-pointer"
