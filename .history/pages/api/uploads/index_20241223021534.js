...
export default async function handler(req, res) {
  ...
  switch (req.method) {
    case METHOD.POST:
      // Video ve kapak resmi yükleme işlemi
    ...
    case METHOD.GET:
      ...
      // Tek bir dosyanın (video veya kapak resmi) URL'sini getir
        ...
        res.status(400).json({
          error: "Missing required parameters: folder, fileName, or set all=true",
        });
      }
      break;
