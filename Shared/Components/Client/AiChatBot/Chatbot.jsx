    ...
    >
      <div 
        className={`max-w-[80%] p-3 rounded-2xl ${
          msg.role === "user" 
            ? "bg-blue-500 text-xl font-normal text-white" 
            : "bg-white text-gray-800 border text-xl font-normal  border-gray-200"
        }`}
      >
        {msg.role === "assistant" && (
    <div
    className=" flex justify-center items-center w-10 h-10 bg-blue-500 hover:bg-blue-600 text-white rounded-full shadow-lg  "
           ...
           >
             <div
               className={`max-w-[80%] p-3 rounded-2xl ${
                 msg.role === "user"
                   ? "bg-blue-500 text-xl font-normal text-white"
                   : "bg-white text-gray-800 text-xl font-normal border border-gray-200"
               }`}
             >
                   {msg.role === "assistant" && (
    <div
